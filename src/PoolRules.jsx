export const POOL_RULES_VERSION = '2026-08'
...
export function PoolRules({ compact = false }) {
  return <div className={`pool-rules ${compact ? 'pool-rules-compact' : ''}`}>
    <div className="pool-facts"><div><small>Hours</small><strong>7:00 a.m. - 9:00 p.m.</strong><span>Daily; the board may adjust hours</span></div><div><small>Replacement card</small><strong>$20</strong><span>Also applies to additional cards</span></div><div><small>Safety</small><strong>No lifeguard</strong><span>Swim at your own risk</span></div></div>
