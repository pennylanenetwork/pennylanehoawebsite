...
function App() {
  ...
  return <main>
    ...
    <PublicUpdates />
    <CommunityGallery />
    <section className="resources-section" id="resources"><div className="section-heading"><p className="section-label">Make yourself at home</p><h2>Useful things,<br /><i>close at hand.</i></h2></div><div className="resource-grid"><a href="/portal" className="resource-card"><h3>Resident portal</h3><p>Member news, documents, and reservations.</p><span className="card-arrow">&#8599;</span></a><a href="#contact" className="resource-card"><h3>Request a review</h3><p>Contact the board about an exterior change.</p><span className="card-arrow">&#8599;</span></a><a href="#contact" className="resource-card"><h3>Find a document</h3><p>Public rules and shared community files.</p><span className="card-arrow">&#8599;</span></a></div></section>
