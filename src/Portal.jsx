...
function ResidentHome({ user, onLogout }) {
  ...
  const [data, setData] = useState({ announcements: [], events: [], documents: [], reservations: [], messages: [], guests: [], household: [] })
        ...
        <section className="auth-panel">
          ...
          {mode === 'login' ? (
            ...
            <form onSubmit={submitRegistration}>
              ...
              <label>Property relationship<select value={registration.residentType} onChange={(event) => setRegistration({ ...registration, residentType: event.target.value })}><option value="owner">Property owner</option><option value="tenant">Renter</option></select></label>
