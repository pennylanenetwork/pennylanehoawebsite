...
function PropertyDetail({ propertyId, onBack, isSuperAdmin }) {
  ...
  const residents = storedResidents.map((resident) => {
    ...
    return { ...resident, residentType: `${residentTypeLabel(resident.residentType)}${agreement ? ` | Pool rules signed ${dateTime(agreement.acknowledgedAt)} (v${agreement.rulesVersion})` : ''}` }
  })
